...
audio_dir="/mnt/external4/xuanchi/output_99/long/audio"

frame_dir="/mnt/external4/xuanchi/output_99/long"
...
do
    ...
    cd $fname
    ffmpeg -y -framerate 10 -i %03d.jpeg output_no_audio.mp4
